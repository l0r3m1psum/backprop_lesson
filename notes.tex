...
% TODO: Discuss the "semantic" implications of back-propagation (or gradient
% calculation in general) i.e. gradient explosion and vanishing together with
...
%  * https://karpathy.github.io/neuralnets/#patterns-in-the-backward-flow
...
% TODO: add sensible definition of free and bound indices (i.e. Laue at al.).

% TODO: Write using this notation only
% https://carldehlin.com/2024/06/05/a-better-notation-for-deep-learning.html
